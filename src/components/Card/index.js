...
export default function Card({image, title, price, id, isAdded = false, onClickAdd, onFavorite}) {
    const [isAddedProduct, setIsAddedProduct] = React.useState(isAdded);

    const handleClickPlus = () => {
        setIsAddedProduct(!isAdded)
        onClickAdd({image, title, price, id, isAdded: !isAddedProduct});
    }
    ...
    return (
        <div className={styles.card}>
            ...
            <div className={styles.card__actions}>
                <button type="button" className={styles.card__icon}> {/* styles.card__icon_favorite */}
