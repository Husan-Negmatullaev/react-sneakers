    ...
    return (
        <div className={styles.card}>
            ...
            <div className={styles.card__actions}>
                <button type="button" className={`${styles.card__icon} ${styles.card__icon_favorite} ${props.active ? styles.active : ''}`}>
            ...
            <div className={styles.card__info}>
                <div className={styles.card__meta}>
                    ...
                    <span className={styles.card__price}>{props.price} руб.</span>
                </div>
                <button onClick={props.onClick} type="button" className={styles.card__button}>
